...
export default function Demo() {
  return (
    <div className='py-5 px-4 md:px-10 lg:px-40'>
      ...
      <div className='flex flex-col md:flex-row gap-5 md:gap-10 justify-between items-center'>
        <div className='md:w-1/2'>
          <h1 className='lg:text-2xl font-semibold mb-3'>Estimated 15 minutes to complete</h1>
        ...
        <Image src='/Rectangle 21.svg' alt='hero image' width={300} height={100} className='w-full md:w-1/2 lg:w-fit' />
      </div>
    </div>
  )
}
