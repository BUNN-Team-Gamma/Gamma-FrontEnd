    ...
    <div className='bg-[#E5FAFF] py-10 lg:py-5 px-4 md:px-10 lg:px-16 2xl:px-40 flex flex-col md:flex-row justify-between items-center'>
      <div>
        ...
        <div className='my-5 flex gap-10 items-center'>
          ...
          <Link href='/' className='flex gap-2 items-center underline hover:no-underline'>
            <Image src='/Group 3.svg' alt='Play' width={100} height={50} className='w-6 lg:w-fit'/>
            <p>Watch demo</p>
          </Link>
        </div>
      </div>
      <Image src='/HeroImage.svg' alt='hero image' width={300} height={100} className='md:w-2/5' />
    </div>
  )
}
